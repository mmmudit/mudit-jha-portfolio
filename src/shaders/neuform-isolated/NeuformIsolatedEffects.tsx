...
function transformEpiludeWordmarkSource(source: string, mode: EffectMode, text?: string) {
  const str = (typeof source === "string" ? source : (source as any)?.default) || epiludeFooterSourceTS;
...
[data-threeui-role="visual"][data-threeui-fit="wide-wordmark"] { width: 100% !important; max-width: 100% !important; height: 100% !important; max-height: none !important; aspect-ratio: 4.444444444444445 !important; padding: 0 !important; overflow: visible !important; }
...
export function ParticleWordmark({ text, ...props }: NeuformIsolatedEffectProps) {
  const definition = useMemo<EffectDefinition>(() => ({
    ...EFFECTS.particleWordmark,
    transformSource: (source, mode) => transformEpiludeWordmarkSource(source, mode, text),
  }), [text]);
