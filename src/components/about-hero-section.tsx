    ...
    <section className="relative w-full pt-28 sm:pt-36">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        ...
        <div className="lg:col-span-4 flex justify-center lg:justify-end pt-4 lg:pt-0">
          ...
          >
            {/* Photo Container */}
            <div className="relative w-full h-[84%] rounded-[12px] overflow-hidden bg-gradient-to-tr from-stone-200 to-stone-100 border border-zinc-200/60">
              <Image
            ...
            {/* Bottom Polaroid Caption Label with Magical Stroke Reveal */}
            <div className="h-[16%] flex items-center justify-between px-1.5 pt-1 text-zinc-700">
