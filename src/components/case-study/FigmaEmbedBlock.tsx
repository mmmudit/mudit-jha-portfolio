...
export function FigmaEmbedBlock({ block, className = "" }: FigmaEmbedBlockProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full rounded-[20px] sm:rounded-[26px] overflow-hidden bg-[#e8ebe4]/60 border border-black/8 shadow-[0_1px_2px_rgba(0,0,0,0.03),0_4px_16px_rgba(0,0,0,0.04),inset_0_1px_0_rgba(255,255,255,0.8)] transition-[height] duration-300 ${
